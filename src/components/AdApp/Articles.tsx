...
import articles from '../../res/data/article';
...
const Articles: React.SFC<Props> = (props) => {
  return (
    <Card>
      <CardText>
        <div className="library-content" dangerouslySetInnerHTML={{ __html: articles[props.match.params.id].text }}></div>
      </CardText>
    </Card>
  );
