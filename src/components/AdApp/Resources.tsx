/*
* Resources.tsx
* A list of the available resources. Each list item links to the page for
      ...
      <ListItem
        ...
        nestedItems={[
          <ListItem
            ...
            onTouchTap={onClick('/articles/0')}
          />,
          <ListItem
            key={1}
            primaryText="Physical Injury-Dealing with Others"
            onTouchTap={onClick('/articles/1')}
          />,
          <ListItem
            key={2}
            primaryText="Adjusting to Injuries"
            onTouchTap={onClick('/articles/2')}
          />,
        ]}
      />
